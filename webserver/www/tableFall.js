...
var position = 0;
	...
	$.getJSON('dataFreescaleTemplate.php', function(data)
	{
		...
		var table = new google.visualization.Table(document.getElementById('tableFall'));
...
$(function()
{
	google.load('visualization', '1', { packages:['table'], callback: loadDataFall });
